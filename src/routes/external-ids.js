...
// GET /api/external-ids/:pageId/properties - 특정 항목의 모든 properties 조회
...
// GET /api/external-ids/:pageId/properties/:propertyName - 특정 property 조회
...
// PATCH /api/external-ids/:pageId/properties - 특정 properties 업데이트
...
// PATCH /api/external-ids/:pageId/properties/:propertyName - 단일 property 업데이트
router.patch('/:pageId/properties/:propertyName', async (req, res) => {
  try {
    ...
    const result = await externalIdsService.updateItem(pageId, {
